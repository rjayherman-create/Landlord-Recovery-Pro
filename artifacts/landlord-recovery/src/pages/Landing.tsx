...
import heroImg from "@/assets/hero-landlord.png";

export default function Landing() {
  return (
    <div className="flex flex-col w-full animate-in fade-in duration-500">
      {/* Hero Section */}
      <section className="relative bg-primary overflow-hidden border-b border-primary-border">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-2 gap-0 min-h-[620px] items-center">
            {/* Left: copy */}
            <div className="py-20 pr-0 md:pr-12">
              ...
              <h1 className="text-5xl md:text-6xl font-serif font-bold text-primary-foreground tracking-tight leading-[1.1] mb-6">
              ...
              <p className="text-xl text-primary-foreground/80 mb-10 max-w-xl leading-relaxed">
                A professional toolkit for landlords to handle small claims court — from the formal demand letter to collecting the final judgment.
              </p>
            ...
            {/* Right: hero image */}
            <div className="hidden md:flex items-end justify-end h-full self-stretch">
              <div className="relative w-full h-full min-h-[480px]">
                {/* Gradient fade on left edge to blend into the dark hero */}
                ...
                <img
                  src={heroImg}
                  alt="Landlord reviewing lease documents"
